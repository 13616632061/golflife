...
public class EventSignUpActivity extends BaseActivity {
    ...
    private void saveQrcodeImage(String filePath) {
        ...
        ImageUtil.saveBitmapFile(bitmap, filePath);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_QRCODE && resultCode == RESULT_OK && data != null) {
            ...
            switch (strings.length) {
                case 1://赛事id
                    json=RequestAPI.SweepCodeSignUpByid(EventSignUpActivity.this,eventIdStr);
    ...
    /**
     * TODO 处理扫码后的数据，访问网络验证信息
     *
     * @param json
     */
    private void handleResult(String json) {
        showLoading();
        String requestJson = RequestAPI.getJson(this, json);
