...
public class SelectProvincesActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    public void getLocation(Location location) {
        ...
        OkGo.get(RequestAPI.getLocation(latitude,longitude))
                .tag(this)//
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, okhttp3.Call call, okhttp3.Response response) {
                        try {
                            ...
                            System.out.println("locationEntity:"+locationEntity.getResults().get(0).getAddress_components().get(3).getLong_name());
    ...
    protected void loadDatas() {
        showLoading();
        String citysJson = RequestAPI.getCitys(this);
        OkGo.post(ConstantsURL.QueryChinaCity)
                .tag(this)//
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (position == 0) {
            if (locationEntity != null) {
                ...
                String editUserInfo = RequestAPI.editUserCity(this,addressid,addressName);
