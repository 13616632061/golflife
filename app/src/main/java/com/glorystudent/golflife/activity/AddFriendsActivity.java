...
import com.glorystudent.golflife.entity.QRUserEntity;
...
public class AddFriendsActivity extends BaseActivity {
    ...
    private void getGolfFriends(String userid) {
        showLoading();
        String requestJson = RequestAPI.QueryUsersByUserID(this,0+"",userid);
        System.out.println("获取好友参数："+requestJson);
        OkGoRequest.getOkGoRequest().setOnOkGoUtilListener(new OkGoRequest.OnOkGoUtilListener() {
            @Override
            public void parseDatas(String json) {
                dismissLoading();
                System.out.println("获取好友："+json);
                try {
        ...
        }).getEntityData(this,ConstantsURL.QueryUsersByUserID, requestJson);
    }
