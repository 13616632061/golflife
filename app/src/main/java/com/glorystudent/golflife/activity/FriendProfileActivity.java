...
public class FriendProfileActivity extends BaseActivity {
    ...
    protected int getContentId() {
        return R.layout.activity_friends_profile_entity;
    }
    @Override
    protected void init() {
        showLoading();
    ...
    private void checkFriend(final String status) {
        ...
        }).getEntityData(this, ConstantsURL.EditApplyFriends, requestJson);
    }
    /**
     * 删除好友
     */
    private void deleteFriend() {
        ...
        }).getEntityData(this,ConstantsURL.DeleteFriends, requestJson);
    }
    ...
    private void requestDatas() {
        String requestJson="";
        if (userid != -1) {
           requestJson = RequestAPI.QueryFriendByUserid(this, userid+"");
        } else if (phoneNumber != null) {
           requestJson = RequestAPI.QueryFriend(this,  phoneNumber+"");
        }
