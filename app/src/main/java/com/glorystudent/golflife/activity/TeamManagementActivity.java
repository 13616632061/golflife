...
import com.glorystudent.golflife.adapter.NearTeamListAdapter;
...
import com.glorystudent.golflife.entity.LocationEntity;
...
public class TeamManagementActivity extends BaseActivity implements AdapterView.OnItemClickListener, TextWatcher {
    ...
    private MyTeamListAdapter myTeamListAdapter;//我的球队适配器
    private NearTeamListAdapter nearTeamListAdapter;//附近球队适配器
    ...
    protected void loadDatas() {
        requestJson = RequestAPI.QueryTeam(TeamManagementActivity.this,0+"",page+"");
        requestData();
    }
    /**
     * TODO 球队列表点击事件
    ...
    private void requestDataByTitle(String text) {
        isRefresh = true;
        page = 1;
        requestJson = RequestAPI.QueryTeamByTitile(this,text,0+"",page+"");
        requestData();
    }
    /**
     * TODO 通过区域id查询数据
    ...
    private void requestDataByRegion(int cid) {
        isRefresh = true;
        page = 1;
        requestJson = RequestAPI.QueryTeamByCityId(this,cid+"",0+"",page+"");
        requestData();
    }
    ...
    public void requestData() {
        System.out.println("获取球队数据requestJson"+requestJson);
        OkGoRequest.getOkGoRequest().setOnOkGoUtilListener(new OkGoRequest.OnOkGoUtilListener() {
            ...
            public void parseDatas(String json) {
                ...
                try {
                    ...
                    System.out.println("获取球队数据jo"+jo);
    ...
    /**
     * todo 得到当前经纬度并开启线程去反向地理编码
     */
    public void getLocation(Location location) {
        String latitude = location.getLatitude() + "";
        String longitude = location.getLongitude() + "";
        String url = RequestAPI.getLocation(latitude,longitude);
        OkGo.get(url)
                .tag(this)//
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, okhttp3.Call call, okhttp3.Response response) {
                        try {
                            ...
                            String city="";
                            if(locationEntity.getResults().size()>0){
                                city = locationEntity.getResults().get(0).getAddress_components().get(2).getLong_name();
                            }
                            tvCity.setText(city);
                        } catch (JSONException e) {
                            e.printStackTrace();
