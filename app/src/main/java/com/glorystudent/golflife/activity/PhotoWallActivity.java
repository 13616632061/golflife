...
import com.glorystudent.golflife.adapter.PhotoWallGridAdapter;
import com.glorystudent.golflife.customView.PullToRefreshLayout;
import com.glorystudent.golflife.customView.PullableGridView;
import com.glorystudent.golflife.entity.PhotoWallEntity;
...
public class PhotoWallActivity extends BaseActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    private int eventActivity_id;//id
    private PhotoWallGridAdapter gridAdapter;//照片墙适配器
    private List<PhotoWallEntity.EventPicWallListBean> datas;//照片墙数据集合
    ...
    protected void loadDatas() {
        //根据活动id获取照片墙
        String requestJson = RequestAPI.QueryEventActivityPicWall(PhotoWallActivity.this,eventActivity_id+"",photoWallPage+"");
        ...
        }).getEntityData(this, ConstantsURL.QueryEventActivityPicWall, requestJson);
    }
