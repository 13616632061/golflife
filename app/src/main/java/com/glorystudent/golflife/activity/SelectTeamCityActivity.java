...
import com.glorystudent.golflife.adapter.CityListAdapter;
import com.glorystudent.golflife.adapter.HotCityGridAdapter;
import com.glorystudent.golflife.adapter.ProvinceGridAdapter;
...
public class SelectTeamCityActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    private String json;
    private List<TeamCityEntity.HotCityListBean> hotCityList;//热门城市数据集合
    private List<TeamCityEntity.CityListBean> datas;
    private List<TeamCityEntity.CityListBean> provinceList;//省份数据集合
    private List<TeamCityEntity.CityListBean> cityList;//市区诗句集合
    private CityListAdapter cityListAdapter;//市区适配器
    private ProvinceGridAdapter provinceGridAdapter;//省份适配器
    @Override
