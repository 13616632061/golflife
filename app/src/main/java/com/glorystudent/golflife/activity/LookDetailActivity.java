...
public class LookDetailActivity extends BaseActivity implements PlatformActionListener {
    ...
    private void initShareModel() {
        ...
        if (datas.getListeventpic() != null && datas.getListeventpic().size() > 0) {
            ...
            //默认图片
            model.setImageUrl(ConstantsURL.imgUrl);
        }
        model.setText(datas.getEventactivity_detail());
        model.setTitle(datas.getEventactivity_name());
        model.setUrl(String.format(ConstantsURL.EVENT_SHARE_URL, datas.getEventActivity_id()));
    }
    ...
    protected void loadDatas() {
        ...
        }).getEntityData(this, ConstantsURL.QueryEventActivityByEventActivityID, requestJson);
    }
    ...
    private void cancelEvent() {
        ...
        sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String requestJson = RequestAPI.canclellEventActivity(LookDetailActivity.this,text,eventActivity_id+"");
                ...
                }).getEntityData(LookDetailActivity.this,ConstantsURL.CancelEventActivity, requestJson);
            }
        });
        //显示popupwindow
