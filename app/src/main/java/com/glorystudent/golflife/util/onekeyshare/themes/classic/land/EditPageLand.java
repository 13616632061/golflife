...
package com.glorystudent.golflife.util.onekeyshare.themes.classic.land;
...
import com.glorystudent.golflife.util.onekeyshare.themes.classic.EditPage;
import com.glorystudent.golflife.util.onekeyshare.themes.classic.XView;
...
public class EditPageLand extends EditPage implements OnClickListener, TextWatcher, Runnable {
	...
	private void initTitle(RelativeLayout rlTitle, float ratio) {
		...
		resId = ResHelper.getStringRes(activity, "请登录账号");
		if (resId > 0) {
