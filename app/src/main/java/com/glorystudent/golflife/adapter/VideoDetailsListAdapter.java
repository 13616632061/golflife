...
public class VideoDetailsListAdapter extends AbsBaseMoreListAdapter<VideoReviewEntity.ListTVideoCommentBean> implements CompoundButton.OnCheckedChangeListener {
    ...
    @Override
    public void bindView(ViewHolder viewHolder, VideoReviewEntity.ListTVideoCommentBean data, Map<Integer, Boolean> auxiliaryDatas) {
