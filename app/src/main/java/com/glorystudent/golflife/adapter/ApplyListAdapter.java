...
import com.glorystudent.golflife.activity.ApplyListActivity;
...
public class ApplyListAdapter extends AbsMoreBaseAdapter<ApplyListEntity.ListsignupBean> {
    ...
    private void allowSign(final ApplyListEntity.ListsignupBean datas, final boolean flag) {
        ...
        String requestJson = RequestAPI.AgreeSignUp(context,datas.getSignup_id()+"",flag);
        ...
        }).getEntityData(context, ConstantsURL.AgreeSignUp, requestJson);
    }
